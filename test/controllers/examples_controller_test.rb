...
class ExamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post examples_url, params: { example: { meaning_id: @example.meaning_id, sentence: @example.sentence, translation: @example.translation } }
    end
  ...
  test "should update example" do
    patch example_url(@example), params: { example: { meaning_id: @example.meaning_id, sentence: @example.sentence, translation: @example.translation } }
